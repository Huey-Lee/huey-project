...
typedef enum {
    BEEP_CLICK = 0,   /* key click    : ~35 ms single tone */
    BEEP_LIMIT,       /* limit hit    : 60 ms × 3 bursts   */
    BEEP_ALARM,       /* error alarm  : 100 ms × 10 beeps  */
    BEEP_POWER_ON,    /* power-on     : 300 ms single tone */
} BeepMode_t;
