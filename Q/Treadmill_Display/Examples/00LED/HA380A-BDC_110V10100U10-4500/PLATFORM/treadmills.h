 ...
 *
 *  ┌─────────────────────┬────────────────────┬────────────────────�? *  �?Parameter           �?110 V motor        �?220 V motor        �? *  ├─────────────────────┼────────────────────┼────────────────────�? *  �?VOLTAGE_MAX         �? 95                �?187                �? *  �?VOLTAGE_MIN         �? 20                �? 40                �? *  �?STA_LEVEL (1..5)    �? 1 (40V/3)         �? 2 (80V/5)         �? *  �?OVER_VOLTAGE_MAX    �?130                �?240                �? *  �?OVER_CURRENT_MAX    �? 30 (same)         �? 30 (same)         �? *  └─────────────────────┴────────────────────┴────────────────────�? *
...
/* === 220 V motor (default) ============================================== */
#define TM_LOWER_VOLTAGE_MAX        93u    /* max drive voltage (V)        */
...
/* HC-32_1：软起仅 CMD_STA_LEVEL(28)，档位表见下�?uart_frame.c�?�?0/3 �?5�?00/8�?*/
#define TM_LOWER_STA_LEVEL          2u    /* 1..5�?20V 典型�?3 */
...
#define TM_LOWER_KIV_1KM             3u   // 1km/h������ 3u����֤�����ܴ�������
#define TM_LOWER_KIV_2KM             2u   // 2km/h
#define TM_LOWER_KIV_3KM             2u   // 3km/h
#define TM_LOWER_KIV_4KM             2u   // �� 0 ��Ϊ 2u���ṩ����֧�ţ���ֹ PID ����
#define TM_LOWER_KIV_5KM             2u   
#define TM_LOWER_KIV_6KM             1u   // �� 0 ��Ϊ 1u������΢��������ֹ���ٶٴ�
#define TM_LOWER_KIV_7KM             1u
#define TM_LOWER_KIV_8KM             1u
#define TM_LOWER_KIV_9KM             1u
#define TM_LOWER_KIV_10KM            1u   // 10km/h��1u �� 110V ϵͳ����꣬��ѹ������
