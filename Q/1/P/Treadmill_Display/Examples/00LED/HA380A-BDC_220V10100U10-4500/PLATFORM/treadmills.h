...
#define TM_LOWER_STA_LEVEL          5u    /* 1..5，220V 典型用 3 */
...
#define TM_LOWER_ACCEL_LEVEL         6u
...
/* Auto-run after boot: speed ramps from min to max. */
#define TM_BOOT_AUTO_ACCEL_STEP         1u   /* +0.1 km/h per step */
#define TM_BOOT_AUTO_ACCEL_100MS        5u   /* every 500 ms       */
