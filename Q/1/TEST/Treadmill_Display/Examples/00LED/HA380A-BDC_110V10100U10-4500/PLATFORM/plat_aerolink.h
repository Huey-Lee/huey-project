...
/* 32..34 原 PID 命令已废弃，下位不再处理 */
#define CMD_OVER_VOLTAGE_MAX       35u
#define CMD_OVER_CURRENT_LOW_SPEED_MAX 36u
/* 与下位 uart_frame.h 一致：KIV_13/14 为 0x30/0x31；缓起缓停为 0x52..0x55 */
#define CMD_KIV_13KM               48u
#define CMD_KIV_14KM               49u
#define CMD_SOFT_START_VOLT          82u
#define CMD_SOFT_START_MS            83u
#define CMD_SOFT_STOP_MS             84u
#define CMD_SOFT_STOP_FLOOR_V        85u
