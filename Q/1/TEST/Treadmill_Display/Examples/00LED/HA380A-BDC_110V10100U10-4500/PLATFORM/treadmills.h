...
#define TM_LOWER_VOLTAGE_MIN        18u    	/* min drive voltage (V)        */
#define TM_LOWER_OVER_VOLTAGE_MAX   140u    /* runaway protection (V)       */
#define TM_LOWER_OVER_CURRENT_MAX   50u
#define TM_LOWER_OVER_CURRENT_MAX_LOW_SPEED 22u
...
#define TM_LOWER_STA_LEVEL          3u    /* 1..10: start-stage PID burst strength */
/* --- Stop ramp: lower board declares stopped when back-EMF < this (V) --- */
#define TM_LOWER_END_LEVEL          2u
...
#define TM_LOWER_KIV_1KM             2u
#define TM_LOWER_KIV_2KM             2u
#define TM_LOWER_KIV_3KM             2u
#define TM_LOWER_KIV_4KM             2u
#define TM_LOWER_KIV_5KM             2u
#define TM_LOWER_KIV_6KM             2u
#define TM_LOWER_KIV_7KM             1u
#define TM_LOWER_KIV_8KM             1u
#define TM_LOWER_KIV_9KM             1u
#define TM_LOWER_KIV_10KM            1u
#define TM_LOWER_KIV_11KM            1u
#define TM_LOWER_KIV_12KM            1u
#define TM_LOWER_KIV_13KM            2u
#define TM_LOWER_KIV_14KM            2u

/* 下位机缓起/缓停（CMD_SOFT_*）：与 motor_t.cfg_* 对应；上电下发统一调参
 * 时长在界面配置里按「秒」填写，下发帧内仍为小端毫秒（×1000），最大约 65s。 */
#define TM_LOWER_SOFT_START_VOLT       7u     /* 起步电压 V */
#define TM_LOWER_SOFT_START_S          5u     /* 起步→VOLTAGE_MIN 总时长（秒） */
#define TM_LOWER_SOFT_STOP_S           15u    /* 缓停总时长（秒）；填 0 则下位用分频默认 24 */
#define TM_LOWER_SOFT_STOP_FLOOR_V     5u     /* 缓停最低端压 V；0=下位默认 PWM 地板 */
...
/* Boot parameter download reliability:
 * send one row -> wait ACK echo -> retry on timeout. */
#define TM_LOWER_CFG_ACK_TIMEOUT_100MS   2u   /* 200 ms */
#define TM_LOWER_CFG_ACK_RETRY_MAX       3u
