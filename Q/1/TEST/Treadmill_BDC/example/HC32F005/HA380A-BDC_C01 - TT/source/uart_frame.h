...
typedef enum _cmd_e
{
  ...
  CMD_KIV_12KM,               /* 0x1B */
	...
	CMD_OVER_VALTAGE_MAX = 35,
	CMD_KIV_13KM = 0x30,
	CMD_KIV_14KM = 0x31,

	CMD_SOFT_START_VOLT = 0x52,     /* len1 起步电压 V */
	CMD_SOFT_START_MS = 0x53,       /* len2 小端 缓起总时长 ms */
	CMD_SOFT_STOP_MS = 0x54,        /* len2 小端 缓停总时长 ms，0=默认分频24 */
	CMD_SOFT_STOP_FLOOR_V = 0x55,   /* len1 缓停最低端压(V)，换算为 PWM 地板 */
}cmd_e;
