...
/* 每拍允许 uk 增量；过大会在猛踩时单拍顶满 → 与中位斜率限制一起用 */
#ifndef UK_STEP_MAX
#define UK_STEP_MAX (8)
#endif
#ifndef UK_STEP_MIN
#define UK_STEP_MIN (-8)
#endif
#ifndef UK_STEP_MAX_LOW_SPD
#define UK_STEP_MAX_LOW_SPD (6)
#endif

/* pid_calc 之后再限：每 ISR 输出占空最多变化（与 UK_STEP 独立兜底） */
#ifndef PWM_OUTPUT_SLEW_PER_ISR
#define PWM_OUTPUT_SLEW_PER_ISR (6u)
#endif
