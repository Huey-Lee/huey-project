...
//		 motor.sta_speed_scale=uart_frame.buf[0];
	...
	{
		case(1):motor.start_valtage = 10;break;
		case(2):motor.start_valtage = 15;break;
		case(3):motor.start_valtage = 20;break;
		case(4):motor.start_valtage = 25;break;
		case(5):motor.start_valtage = 30;break;
	}
		break;
