...
///< LED
#define STK_LED_PORT        GpioPort2
#define STK_LED_PIN         GpioPin3
#define port_on  Gpio_WriteOutputIO(STK_LED_PORT,STK_LED_PIN,1)
#define port_off Gpio_WriteOutputIO(STK_LED_PORT,STK_LED_PIN,0)
///< XTH
