...
#define TM_LOWER_VOLTAGE_MIN        23u    /* min drive voltage (V)        */
#define TM_LOWER_OVER_VOLTAGE_MAX   140u    /* runaway protection (V)       */
#define TM_LOWER_OVER_CURRENT_MAX   40u
...
#define TM_LOWER_STA_LEVEL          2u    /* 1..5，220V 典型用 2 */
...
#define TM_STOP_TIME_COUNT              400u
