 ...
 * 硬件接口连接定义
 */
#define TM_CS(a)   Gpio_WriteOutputIO(GpioPort3, GpioPin2, a);
#define TM_DIO(a)  Gpio_WriteOutputIO(GpioPort2, GpioPin3, a);
#define TM_CLK(a)  Gpio_WriteOutputIO(GpioPort2, GpioPin4, a);
