...
void treadmills_proc_loop(void)
{
	...
	case STATUS_ERROR:
		...
		set_bit_seg(2,SEG_E);
		set_bit_seg(3,seg_num[treadmills.error_code%10]);
		set_bit_seg(0,SEG_ALL_OFF);//seg_num[0],treadmills.error_code/10
		set_bit_seg(1,SEG_ALL_OFF);//%10
