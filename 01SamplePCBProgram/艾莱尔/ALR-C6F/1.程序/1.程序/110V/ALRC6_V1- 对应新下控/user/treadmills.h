...
#define  TREADMILLS_SPEED_MAX   (600)  //最大速度等级 10公里
#define  TREADMILLS_SPEED_MIN   (100)  //最小速度等级 1 公里
#define  TREADMILLS_SPEED_STEP  (10)   //调准步长 0.25 公里

#define STOP_DISPLAY_INTERVAL (25)  //base time:10ms 停止的时候倒计时速度，数字大倒计时慢
