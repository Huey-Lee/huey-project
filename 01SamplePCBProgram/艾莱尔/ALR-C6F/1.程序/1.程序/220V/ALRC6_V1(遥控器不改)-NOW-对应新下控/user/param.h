...
#define DEFAULT_SPEED_MAX              (800)  //此处修改记得和treadmills.h里的最大速度一同修改
#define DEFAULT_SPEED_MIN              (100)  //最小速度
#define DEFAULT_VOLTAGE_MAX            (180)  //此处修改记得和treadmills.h里的电压一同修改
#define DEFAULT_VOLTAGE_MIN            (45)   //此处修改记得和treadmills.h里的电压一同修改    24
#define DEFAULT_OVER_CURRENT_MAX       (40)   //过流,220V=40;110V=30	//2025.2.20:40
