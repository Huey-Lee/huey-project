...
#define _SEG_A    (1 << 0)//(1 << 1)//
#define _SEG_B    (1 << 7)//(1 << 2)//
#define _SEG_C    (1 << 4)//(1 << 5)//
#define _SEG_D    (1 << 6)//(1 << 4)//
#define _SEG_E    (1 << 5)//(1 << 5)//
#define _SEG_F    (1 << 1)//(1 << 0)//
#define _SEG_G    (1 << 2)//(1 << 6)//
#define _SEG_DP   (1 << 3)

//#define _SEG_A    (1 << 1)//(1 << 1)//
//#define _SEG_B    (1 << 3)//(1 << 2)//
//#define _SEG_C    (1 << 6)//(1 << 5)//
//#define _SEG_D    (1 << 0)//(1 << 4)//
//#define _SEG_E    (1 << 5)//(1 << 5)//
//#define _SEG_F    (1 << 2)//(1 << 0)//
