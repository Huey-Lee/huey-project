...
/* --- 世界顶级手感参数 (10ms为基准) --- */
#define RF_SUSTAIN_TICKS     30   // 300ms 维持窗口 (433遥控器发包间隔通常<100ms)
#define HOLD_START_TICKS    100   // 1000ms (1.0秒) 后才判定为长按，解决误触发
#define REPEAT_RATE_TICKS    15   // 150ms 连发速率 (调数值越小越快)
