...
{
    stc_bt_cfg_t   	  stcCfg;
    uint16_t          u16ArrData = 0x10000 - 24000;		// 10ms中断一次 0x10000 - 24000;		// 10ms中断一次
...
{
    stc_bt_cfg_t   	  stcCfg;
    uint16_t          u16ArrData = 0x10000 - 1434;		// 10ms中断一次
    uint16_t          u16InitCntData = 0x10000 - 10000;
...
//	App_AdvTimer6Init(CBValue-1, CBValue, CBValue);
	
	Adt_StartCount(M0P_ADTIM4); //AdvTimer4运行
//	Adt_StartCount(M0P_ADTIM6); //AdvTimer4运行
