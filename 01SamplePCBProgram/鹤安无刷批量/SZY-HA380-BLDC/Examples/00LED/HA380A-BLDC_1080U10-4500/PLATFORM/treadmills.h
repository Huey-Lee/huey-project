 ...
 *   TM_SPEED_MAX = 100 -> 10.0 km/h
 * Downlink (上显→下控): 17 字节帧 AA BB 0x0A FC SFC Data×8 CS_H CS_L EE FF
 *   档位 FC=0x03 SFC=0x00：目标档位在 Data1（大端），10 = 1.0 km/h
 */
 ...
 *     下控运行信息 FC01/00 的 Data3/Data4（大端）为最大/最小挡位时，上显据此收紧调节范围（仍夹在下列宏之间）。
 *===========================================================================*/
#define TM_SPEED_MIN                10u     /* 1.0 km/h — minimum */
#define TM_SPEED_MAX                100u    /* 10.0 km/h — maximum */
