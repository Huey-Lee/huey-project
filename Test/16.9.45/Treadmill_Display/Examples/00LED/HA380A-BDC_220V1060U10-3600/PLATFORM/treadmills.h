...
#define TM_SPEED_MAX                60u     /* 8.0 km/h — maximum */
...
/* === 220 V motor (default) ============================================== */
#define TM_LOWER_VOLTAGE_MAX        170u    /* max drive voltage (V)        */
#define TM_LOWER_VOLTAGE_MIN        43u    	/* min drive voltage (V)        */
#define TM_LOWER_OVER_VOLTAGE_MAX   240u    /* runaway protection (V)       */
#define TM_LOWER_OVER_CURRENT_MAX   30u
#define TM_LOWER_SPEED_MAX_PARAM    60u     /* 6.0 km/h */
...
#define TM_LOWER_STA_LEVEL          4u    /* 1..5，220V 典型用 2 */
/* --- Stop ramp: lower board declares stopped when back-EMF < this (V) --- */
#define TM_LOWER_END_LEVEL          12u
...
#define TM_LOWER_KIV_1KM             5u
#define TM_LOWER_KIV_2KM             5u
#define TM_LOWER_KIV_3KM             4u
#define TM_LOWER_KIV_4KM             4u
 ...
 *   At 8.0 km/h: 450 × 80/80 = 450 ticks = 45.0 s */
#define TM_STOP_TIME_COUNT              200u
